...
FlowsDataService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: FlowsDataService, deps: [{ token: i1.StoragePersistenceService }, { token: i2.RandomService }, { token: i3.ConfigurationProvider }, { token: i4.LoggerService }], target: i0.ɵɵFactoryTarget.Injectable });
